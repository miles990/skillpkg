  ...
  private mergeSkillsForTarget(
    ...
    switch (targetConfig.id) {
      case 'codex':
        ...
        break;
      case 'copilot':
        sections.push('# GitHub Copilot Custom Instructions\n');
        sections.push('These are custom instructions for GitHub Copilot.\n');
        sections.push('\n> Generated by [skillpkg](https://github.com/miles990/skillpkg)\n');
        break;
      default:
        // Generic header for other single-file targets
        sections.push(`# ${targetConfig.displayName} Instructions\n`);
        sections.push('AI agent skills for this project.\n');
    }
